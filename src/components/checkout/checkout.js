...
export function Checkout (props) {
  ...
  //definição para validação usando yup
    ...
    <Form noValidate style={{ margin: '10px' }} onSubmit={handleSubmit}>
      ...
      <Form.Group as={Row} controlId="nomeCompleto">
        ...
        <Col sm={9}>
          ...
          <Form.Control.Feedback type="invalid">Digite seu nome completo. Com no minimo 5 carateres.</Form.Control.Feedback>
        </Col>
      </Form.Group>
      ...
      <Form.Group as={Row} controlId="estado">
        ...
        <Col sm={9}>
          <Form.Control
            ...
            >
            <ListarEstados estado={values.estado}/>
          </Form.Control>
          <Form.Control.Feedback type="invalid">
